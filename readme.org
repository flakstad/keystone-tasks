...
** TODO move script to create new into todo-list.js
** TODO some sort of history and undo would be good
could we implement history
...
** TODO make counter 1/5 etc be a cake diagram, or change to cyan color when 100%
